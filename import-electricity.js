...
async function run() {
  ...
  if (!targetChapter) {
      console.log("⚠️ Could not find an existing 'Electricity' chapter. Trying to create it in Eduvate.");
      ...
      targetChapter = await Chapter.create({ subjectId: subject._id, title: 'Chapter 14: Electricity', order: 14 });
  } else {
