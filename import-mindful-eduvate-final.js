...
async function run() {
  ...
  if (!targetChapter) {
      ...
      console.log(`✅ Found Target Chapter in Eduvate: ${targetChapter.title}. Updating name to 'Chapter 2: Components of food'...`);
      targetChapter.title = 'Chapter 2: Components of food';
      targetChapter.order = 2;
  ...
  for (const filePath of existingFiles) {
    ...
    const idxLesson = headers.findIndex(h => h.includes('lesson_title') || h.includes('lesson title') || h === 'lesson');
  ...
  console.log("\n🎉 All CSVs successfully uploaded directly to the 'Components of food' chapter in Eduvate!");
  process.exit(0);
}
