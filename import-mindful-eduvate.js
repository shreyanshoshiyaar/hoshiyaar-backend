...
async function run() {
  ...
  const files = [
    'D:\\Mindful eating - A path to a healthy body - Mindful eating - A path to a healthy body- eduvate.csv'
  ];
  ...
  console.log("\n🎉 All CSVs successfully uploaded directly to the 'Mindful eating' chapter in Eduvate!");
  process.exit(0);
}
