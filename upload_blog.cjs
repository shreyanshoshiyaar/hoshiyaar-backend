...
<ol>
  ...
  <li>Remove carefully and store safely.</li>
       ...
       const blogData = JSON.stringify({
         ...
         category: 'Science',
         excerpt: 'Myra had a fever. Hoshi reached for a thermometer — but grabbed the laboratory one by mistake. Why does it matter which thermometer you use? Because a clinical thermometer and a laboratory thermometer are built differently, used differently, and have completely different ranges.',
         content: blogContent,
         author: 'Hoshi',
